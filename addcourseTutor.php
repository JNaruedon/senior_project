		            ...
		            <div class="row">
		                ...
		                <div class="col-sm-7">
										<!-- enctype='multipart/form-data' -->
												<form action="confirmaddcourseTutor.php" method="post" enctype='multipart/form-data'>
		                    <!-- <form role="form" method="post" action="confirmaddpromotiontutor.php" enctype='multipart/form-data'> -->
		                    	...
		                    	<div class="form-group">
		                        	...
		                        	<input type="text" name="nametutor" placeholder="ชื่อผู้สอน" class="contact-name form-control" id="nametutor">
		                        </div>
	  	                        	...
	  	                        	<input type="text" name="price" placeholder="ราคา" class="contact-name form-control" id="price">
														...
														<div class="form-group">
															<label>เวลาที่สอน</label>
																<input type="text" name="times" placeholder="เวลาที่สอน" class="contact-name form-control" id="times">
														</div>
