...
<html lang="en">
    ...
    <fieldset>
        ...
        <label class="col-md-3 control-label" >วิชาที่สมัคร</label>
        <div class="col-md-9">
						<!-- <label><?php echo $fetch['courseid']?> <?php echo $fetch['subject']?></label> -->
            <label> <?php echo $fetch['subject']?></label>
        </div>
      </div>

    <div class="form-group">
      <label class="col-md-3 control-label" >ชื่อผู้สมัคร</label>
      <div class="col-md-9">
          <label><?php echo $fetch['fname']?> &nbsp &nbsp<?php echo $fetch['lname']?></label>
      </div>
    </div>

		<div class="form-group">
      <label class="col-md-3 control-label" >วันเวลาที่สมัคร</label>
      <div class="col-md-9">
          <label><?php echo $fetch['time']?> &nbsp &nbsp<?php echo $fetch['date']?></label>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-9">
          <label><?php echo $fetch['phone']?></label>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-9">
					<label><?php echo $fetch['address']?></label>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-9">
          <label><?php echo $fetch['code']?></label>
      </div>
    </div>
		...
		<!-- <li><a href="printregisTutor.php?idgg=<?=$Det?>"><span aria-hidden="true" class=""></span><br>Print</a></li> -->
		<br><a href="printregisTutor.php?idgg=<?=$Det?>"><span aria-hidden="true" class="icon_printer-alt"></span><br>Print</a>
