...
mysql_query("SET character_set_connection=utf8");
 ...
 $IDD = isset($_POST['id']) ? $_POST['id'] : ''; //เก็บค่า id ของคนที่ login ไว้เตรียมส่งไปให้หน้าอื่นใช้ต่อ
 ...
 else
 {
  ...
  if($_SESSION['status'] == "1"){
    header("location:indexStudent.php");//ย้ายไปยังหน้าหลัก
  }
   else if($_SESSION['status'] == "0")
   {
     header("location:indexTutor.php");//ย้ายไปยังหน้าหลัก
   }
