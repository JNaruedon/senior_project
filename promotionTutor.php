...
<!--
              ...
              <br> -->
             	...
             	<?php
                    ...
                    $sql ="SELECT * FROM 3e_promotion where 3e_promotion.checkid=$newid";
                            ...
                            <div class="thumbnail">
                                ...
                                <!-- <div class="portfolio-box-text"> -->
                                    <h3><?php echo $fetch['name_promotion']?></h3>
																		<?PHP $GN =$fetch['id'] ?>
																			<a href="detailpromotionTutor.php?idgn=<?=$GN?>" class="btn btn-default">รายละเอียดเพิ่มเติม</a>
																			<br><a href="UpdatepromotionTutor.php?idupgn=<?=$GN?>" class="btn btn-primary">Edit</a>
																			<a href="JavaScript:if(confirm('Confirm Delete?') == true){window.location='DeletepromotionTutor.php?CusID=<?=$GN?>';}" class="btn btn-primary">Delete</a>
